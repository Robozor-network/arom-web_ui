...
(function($) {
    ...
    function VirtualSky(input) {
        ...
        this.file = {
            ...
            horizont: this.dir + "horizont.json",
        ...
        this.langs = [{
            ...
            horizont: "toggle local horizont line",
    ...
    VirtualSky.prototype.createSky = function() {
        ...
        if (!this.horizont) {
            this.load("horizont", this.file.horizont)
        }
    ...
    VirtualSky.prototype.draw = function(proj) {
        ...
        this.drawGridlines("az").drawGridlines("eq").drawGridlines("gal").drawGalaxy().drawHorizont().drawConstellationLines().drawConstellationBoundaries().drawStars().drawEcliptic().drawMeridian().drawPlanets().drawMeteorShowers().drawCardinalPoints();
        for (var i = 0; i < this.pointers.length; i++) {
            this.highlight(i)
        }
    ...
    VirtualSky.prototype.drawHorizont = function(colour) {
        if (!this.horizont || !this.showhorizont) {
            return this
        }
        if (!colour) {
            colour = this.col.horizont
        }
        this.ctx.beginPath();
        this.ctx.strokeStyle = colour;
        this.ctx.fillStyle = colour;
        ...
        var p, pa, pb, i, c, old, maxl;
        maxl = this.maxLine(5);
        for (c = 0; c < this.horizont.length; c++) {
            if (!this.horizontprocessed) {
                for (i = 1; i < this.horizont[c].length; i++) {
                    this.horizont[c][i] *= this.d2r
                }
            }
            p = this.horizont[c].slice(0);
            p.shift();
            pa = null;
            for (i = 0; i < p.length; i += 2) {
                ...
                //console.log(p[i], p[i + 1], pb)
                pa = pb
            }
        }
        this.horizontprocessed = true;
        this.ctx.stroke();
        return this
    };
    ...
    VirtualSky.prototype.toggleHorizont = function() {
        this.showhorizont = !this.showhorizont;
        this.draw();
        return this
    };
    VirtualSky.prototype.toggleMeteorShowers = function() {
